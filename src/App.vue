<template>
<div class="min-h-screen w-screen md:flex items-center justify-center bg-purple-700 md:bg-gray-200">
  <div class="relative md:my-16">
    <div class="absolute transform -rotate-6 bg-pink-300 w-full h-full rounded-xl hidden md:block" />
    <div class="relative bg-purple-600 text-white md:rounded-xl md:shadow-xl max-w-xl">
      <div class="p-8 md:p-16 pb-8">
        <h2 class="text-purple-300 font-normal text-xl md:text-2xl">Donderdag 16 september 2021</h2>
        <h1 class="font-extrabold text-3xl md:text-4xl mb-8">Dag van de Leidster</h1>
